...
import india_fo_trading as trading  # Indian F&O (Zerodha Kite Connect) - paper mode by default
# import trading                      # <- crypto futures module (ccxt); switch back if needed
...
def process_command(command, user_name):
    ...
    # Autonomous futures trading (paper mode by default - see trading.py)
